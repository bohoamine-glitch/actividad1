...
![Captura de pantalla](./img/crear%20repositorio.png)
...
![Captura de pantalla](./img/clonar%20el%20repositorio%20de%20alvaro.png)

3.Crea una nueva rama (branch) con la ayuda de la UI de GitKraken :
--he creado una rama y lo he llamado cambios1.
![Captura de pantalla](./img/crear%20un%20branch.png)
...
![Captura de pantalla](./img/combios%20en%20primera%20branche.png)

5.Realiza al menos un commit y un push a esta branch.
--he hecho un commit y un push a la rama cambios1.
![Captura de pantalla](./img/hacer%20el%20commites.png)
